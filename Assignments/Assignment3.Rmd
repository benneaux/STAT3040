...
=======
output: pdf_document
>>>>>>> 69f5d16cdbe7c76458ae04e80e0f10d150a42a29
---
        ...
        log
          \left(
            \frac
              ...
              {f_{\pmb{X}}(x;\pmb{\theta}_{2})}
          \right)d\pmb{X} \\
      &= \int\limits_{\mathbb{R}^{2}}f_{\pmb{X}}(x;\pmb{\theta}_{1}) \, 
>>>>>>> 69f5d16cdbe7c76458ae04e80e0f10d150a42a29
          log
            \left(
              \frac
...
=======
            \int\limits_{\mathbb{R}^{2}}f_{\pmb{X}}(x;\pmb{\theta}_{1})\,d\pmb{X}
          - \frac
              {({x}-{Z\beta_{1}})'({x}-{Z\beta_{1}})}{2\,\Gamma_{1}}
            \int\limits_{\mathbb{R}^{2}}f_{\pmb{X}}(x;\pmb{\theta}_{1})\,d\pmb{X}
          + \frac
              {1}{2\,\Gamma_{2}}
            \int\limits_{\mathbb{R}^{2}}f_{\pmb{X}}(x;\pmb{\theta}_{1}) \,
...
Here we need to recall a few things. Firstly, $f_{\pmb{X}}(x;\pmb{\theta})$ is a pdf and therefore integrates to $1$. Secondly, we have that $({x}-{Z\beta_{1}})'({x}-{Z\beta_{1}}) = \Gamma_{1}$.
...
=======
       \int\limits_{\mathbb{R}^{2}}f_{\pmb{X}}(x;\pmb{\theta}_{1}) \,
            ({x}-{Z\beta_{2}})'({x}-{Z\beta_{2}})\,d\pmb{X}
        &= \Gamma_{1} + \frac{(Z\beta_{1} - Z\beta_{2})'(Z\beta_{1} - Z\beta_{2})}{n} \\
        &= \Gamma_{1} + \frac{(\beta_{1} - \beta_{2})'Z'Z(\beta_{1} - \beta_{2})}{n} 
>>>>>>> 69f5d16cdbe7c76458ae04e80e0f10d150a42a29
    \end{aligned}
  $$
