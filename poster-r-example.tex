...
\setbeamertemplate{footline}{
  ...
  \begin{beamercolorbox}[ht=4ex,leftskip=1cm,rightskip=1cm]{footline}%
    \url{newcastle.edu.au} \hfill School of Science and IT, University of Newcastle, Australia \hfill \texttt{author@university.edu}
    \vskip.8ex
  \end{beamercolorbox}
}
...
\title{Time-series Analysis of Self-reported Influenza-like Illness}
\author{Poster Author 1 \and Poster Author 2 \and Poster Author 3}
...
\begin{figure}[htbp]
\centering
\includegraphics{\{width=0.5/linewidth\}presentation-examplefig,\{width=0.5/linewidth\}presentation-examplefig-magenta}
\caption{two figures side-by-side}
\end{figure}

\subsubsection{Default lists}\label{default-lists}
...
\section{Iris data}\label{iris-data}
...
\section{Big figure}\label{big-figure}
